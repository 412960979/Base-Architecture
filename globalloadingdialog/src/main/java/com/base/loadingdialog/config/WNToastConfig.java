package com.base.loadingdialog.config;
...
public class WNToastConfig {
    ...
    private WNToastConfig() {
    }

    public static class Builder {

        private WNToastConfig mToastConfig = null;

        public Builder() {
            mToastConfig = new WNToastConfig();
        }

        public WNToastConfig build() {
            return mToastConfig;
        }
