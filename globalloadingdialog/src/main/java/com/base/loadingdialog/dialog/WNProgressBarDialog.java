...
import com.base.loadingdialog.view.WNCircularProgressBar;

/**
 * 带进度条的Dialog
 */

public class WNProgressBarDialog {
    ...
    private WNProgressBarDialog.Builder mBuilder;

    private RelativeLayout dialog_window_background;
    private RelativeLayout dialog_view_bg;
    private TextView tvShow;
    private ProgressBar horizontalProgressBar;
    private WNCircularProgressBar circularProgressBar;

    public WNProgressBarDialog(Context context) {
        this(context, new WNProgressBarDialog.Builder(context));
    }

    public WNProgressBarDialog(Context context, WNProgressBarDialog.Builder builder) {
        mContext = context;
        mBuilder = builder;
        if (mBuilder == null) {
            mBuilder = new WNProgressBarDialog.Builder(mContext);
        }
        //初始化
        initDialog();
    }
    ...
    private void initDialog() {
        ...
        try {
            ...
            View mProgressDialogView = inflater.inflate(R.layout.wn_progress_bar_dialog_layout, null);
            ...
            circularProgressBar = (WNCircularProgressBar) mProgressDialogView.findViewById(R.id.circularProgressBar);
    ...
    public void refreshBuilder(WNProgressBarDialog.Builder builder) {
        mBuilder = builder;
        configView();
    }
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            ...
            backgroundViewColor = mContext.getResources().getColor(R.color.wn_colorDialogViewBg);
            strokeColor = mContext.getResources().getColor(R.color.wn_colorDialogTrans);
            textColor = mContext.getResources().getColor(R.color.wn_colorDialogTextColor);
            cornerRadius = 6;
            strokeWidth = 0;
            progressbarBackgroundColor = mContext.getResources().getColor(R.color.wn_colorDialogProgressBarBgColor);
            progressColor = mContext.getResources().getColor(R.color.wn_colorDialogProgressBarProgressColor);
        ...
        public WNProgressBarDialog build() {
            return new WNProgressBarDialog(mContext, this);
        }
