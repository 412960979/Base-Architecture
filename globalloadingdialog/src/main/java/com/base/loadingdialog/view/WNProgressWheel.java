package com.base.loadingdialog.view;
...
public class WNProgressWheel extends View {
  private static final String TAG = WNProgressWheel.class.getSimpleName();
   ...
   */
  public WNProgressWheel(Context context, AttributeSet attrs) {
    super(context, attrs);

    parseAttributes(context.obtainStyledAttributes(attrs, R.styleable.WNProgressWheel));
   ...
   * The constructor for the ProgressWheel
   */
  public WNProgressWheel(Context context) {
    super(context);
    setAnimationEnabled();
  }
  ...
  private void parseAttributes(TypedArray a) {
    ...
    circleRadius =
        (int) a.getDimension(R.styleable.WNProgressWheel_wn_circleRadius, circleRadius);

    fillRadius = a.getBoolean(R.styleable.WNProgressWheel_wn_fillRadius, false);

    barWidth = (int) a.getDimension(R.styleable.WNProgressWheel_wn_barWidth, barWidth);

    rimWidth = (int) a.getDimension(R.styleable.WNProgressWheel_wn_rimWidth, rimWidth);

    float baseSpinSpeed =
        a.getFloat(R.styleable.WNProgressWheel_wn_spinSpeed, spinSpeed / 360.0f);
    spinSpeed = baseSpinSpeed * 360;

    barSpinCycleTime =
        a.getInt(R.styleable.WNProgressWheel_wn_barSpinCycleTime, (int) barSpinCycleTime);

    barColor = a.getColor(R.styleable.WNProgressWheel_wn_barColor, barColor);

    rimColor = a.getColor(R.styleable.WNProgressWheel_wn_rimColor, rimColor);

    linearProgress = a.getBoolean(R.styleable.WNProgressWheel_wn_linearProgress, false);

    if (a.getBoolean(R.styleable.WNProgressWheel_wn_progressIndeterminate, false)) {
      spin();
    }
